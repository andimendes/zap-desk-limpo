              ...
              {abaAtiva === 'detalhes' && (
                <div className="space-y-4 dark:text-gray-300">
                  ...
                  <div>
                    ...
                    <select value={responsavelId} onChange={(e) => handleMudarResponsavel(e.target.value)} className="w-full p-2 border rounded-lg bg-white dark:bg-gray-700 dark:border-gray-600">

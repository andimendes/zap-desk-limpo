...
// <-- CORREÇÃO: Caminhos simplificados para remover a subpasta 'admin'/'Admin' -->
import CargosEPermissoesPage from './pages/CargosEPermissoesPage';
import GestaoDeEquipaPage from './pages/GestaoDeEquipaPage';

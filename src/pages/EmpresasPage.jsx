...
export default function EmpresasPage() {
    ...
    const fetchData = useCallback(async () => {
        ...
        if (error) {
            ...
            // Otimização: processa os dados aqui uma vez
    ...
    const handleCloseEmpresaModal = () => {
        ...
        setSelectedEmpresa(null); // Limpa o estado ao fechar
    };
    ...
    const handleDelete = async (empresaId) => {
        if (window.confirm('Tem a certeza de que quer excluir esta empresa e todos os seus contatos associados?')) {
            // O ideal é ter uma função no Supabase para tratar isso em cascata (RPC)
            // Mas, por agora, vamos apagar as ligações e depois a empresa
            ...
            <div className="max-w-7xl mx-auto">
                 <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={handleImport} className="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 text-gray-600 dark:text-gray-300"><Upload size={16}/></button>
